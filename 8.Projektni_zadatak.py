...
# Form implementation generated from reading ui file 'sucelje.ui'
#
...
from korisnik import TipKorisnika, PrivatniKorisnik, PoslovniKorisnik
from artikl import TipArtikla, Automobil, Stan
from prodaja import Prodaja
from utilities import provjera_korisnika, provjera_artikla, provjera_prodaje
...
class Window(QtWidgets.QMainWindow):
    ...
    def initUI(self):
        self.font = QtGui.QFont('TimesNewRoman', 8)
    ...
    def unos_korisnika(self):
        if self.tip_korisnika.currentText() == TipKorisnika.PRIVATNI.value:
            error_korisnik = provjera_korisnika(self.text_telefon.text(), self.text_email.text(),
        ...
        if error_korisnik is None:
            ...
            self.label_error_korisnik.setText(error_korisnik)
    ...
    def unos_artikla(self):
        if self.tip_artikla.currentText() == TipArtikla.AUTOMOBIL.value:
            error_artikl = provjera_artikla(self.text_naslov.text(), self.text_opis.text(),
        ...
        if error_artikl is None:
            ...
            self.label_error_artikl.setText(error_artikl)
    ...
    def unos_prodaje(self):
        error_prodaja = provjera_prodaje(self.prodaja_tip_korisnika.currentText(),
        ...
        if error_prodaja is None:
            ...
            self.label_error_prodaja.setText(error_prodaja)
